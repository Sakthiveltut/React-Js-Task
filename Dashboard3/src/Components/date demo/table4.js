          ...
          <tbody className="table-group-divider">
            ...
            {deletedRows.map((row) => (
              <tr
                ...
                style={{
                  borderTop: '10px solid white',
                  backgroundColor: 'lightcoral', // Background color for deleted rows
                  lineHeight: '20px',
                }}
              >
                <td style={{ backgroundColor: '#89c5f5', position: 'relative' }}>
                ...
                <td>
                  <button
                    className="border-0"
                    type="button"
                    style={{ borderRadius: '150px', backgroundColor: 'green' }}
                    onClick={() => handleUndoDelete(row.id)}
                  >
                    <i className="fa fa-undo" aria-hidden="true" style={{ fontSize: '15px', color: 'white' }}></i>
                  </button>
                </td>
              </tr>
            ))}
